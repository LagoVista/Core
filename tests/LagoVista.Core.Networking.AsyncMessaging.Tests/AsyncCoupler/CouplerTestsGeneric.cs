...
using LagoVista.IoT.Coupler.Tests.Utils;
...
namespace LagoVista.IoT.Coupler.Tests
{
    [TestClass]
    public class CouplerTestsGeneric
    {
        ...
        public void Init()
        {
            _coupler = new AsyncCoupler<TestModelGenerics>(new TestLogger(), new TestUsageMetrics("rpc", "rcp", "rpc") { Version = "N/A" });
        }
