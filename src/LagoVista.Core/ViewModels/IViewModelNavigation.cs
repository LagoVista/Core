...
namespace LagoVista.Core.ViewModels
{
    public interface IViewModelNavigation
    {
        ...
        Task NavigateAndViewAsync<TViewModel>(object parent, object child, params KeyValuePair<string, object>[] args) where TViewModel : ViewModelBase;
        ...
        Task NavigateAndViewAsync<TViewModel>(object parent, String id, params KeyValuePair<string, object>[] args) where TViewModel : ViewModelBase;
