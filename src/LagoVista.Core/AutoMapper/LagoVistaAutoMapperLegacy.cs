...
namespace LagoVista.Core.AutoMapper
{
    ...
    public sealed class LagoVistaAutoMapperLegacy : ILagoVistaAutoMapper
    {
        ...
        public LagoVistaAutoMapperLegacy(IEncryptedMapper encryptedMapper, IMappingPlanBuilder planBuilder)
        {
